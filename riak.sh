...
echo "Configuring riak.conf settings" >> ../../provision.log
...
# Below this is the routine needed to download and build the Erlang client right on this VM
# This is not done be default. Uncomment all code below here to do so! 
####
# cd ../..
